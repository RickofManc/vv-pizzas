...
class Order:
    ...
    """
    def confirm_order(self, cust_order):
        """
        ...
        while True:
            ...
            cust_order = input(f"{Customer.name} you have ordered a {Size.size} {Topping.topping} is this ready to be sent to the kitchen? Y/N:\n")
...
def main():
    ...
    """
    cust_data = Customer.get_customer_data()
    cust_topping = Topping.get_topping()
    cust_size = Size.get_size()
    cust_order = Order.confirm_order()
